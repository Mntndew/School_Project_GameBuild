...
namespace GameBuild.Menu
{
    public class StartMenu
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (play)
            {
                spriteBatch.Draw(playButtonSelected, new Rectangle(540 - (playButtonSelected.Width/2), 300, playButtonSelected.Width, playButtonSelected.Height), Color.White);
                spriteBatch.Draw(exitButtonDeselected, new Rectangle(540 - (playButtonSelected.Width / 2), 500, exitButtonDeselected.Width, exitButtonDeselected.Height), Color.White);
            }
            else
            {
                spriteBatch.Draw(playButtonDeselected, new Rectangle(540 - (playButtonSelected.Width / 2), 300, playButtonDeselected.Width, playButtonDeselected.Height), Color.White);
                spriteBatch.Draw(exitButtonSelected, new Rectangle(540 - (playButtonSelected.Width / 2), 500, exitButtonSelected.Width, exitButtonSelected.Height), Color.White);
            }
            spriteBatch.End();
        }
    }
